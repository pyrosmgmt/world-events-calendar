...
Per-category coverage. **Subscribe** = zero-maintenance official/third-party feed. **Custom** = generated from events.yaml (yearly refresh). **Hybrid** = subscribe feed + curated top-up.
